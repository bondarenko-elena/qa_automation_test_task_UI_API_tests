Title: Discount is calculated incorrectly when applied after adding multiple items
Priority: High
Severity: Major

Environment
	- API: /cart/{cartId}/discount
...
Steps to Reproduce:
	...
	4. (In some cases) add more items after applying the discount
	5. GET /cart/{cartId}
...
Root Cause: It seems the service doesn’t recalculate the discount after adding more items.
